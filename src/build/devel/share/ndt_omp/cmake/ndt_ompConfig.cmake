...
if("TRUE" STREQUAL "TRUE")
  set(ndt_omp_SOURCE_PREFIX /home/qian/my_lio_sam/src/ndt_omp)
  set(ndt_omp_DEVEL_PREFIX /home/qian/my_lio_sam/src/build/devel)
...
if(NOT "/home/qian/my_lio_sam/src/ndt_omp/include " STREQUAL " ")
  set(ndt_omp_INCLUDE_DIRS "")
  set(_include_dirs "/home/qian/my_lio_sam/src/ndt_omp/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ndt_omp' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/qian/my_lio_sam/src/ndt_omp/${idir}'.  ${_report}")
    endif()
