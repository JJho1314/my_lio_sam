...
if(ukf_localization_CONFIG_INCLUDED)
  return()
endif()
set(ukf_localization_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(ukf_localization_SOURCE_PREFIX /home/qian/my_lio_sam/src/ukf_localization)
  set(ukf_localization_DEVEL_PREFIX /home/qian/my_lio_sam/src/build/devel)
  set(ukf_localization_INSTALL_PREFIX "")
  set(ukf_localization_PREFIX ${ukf_localization_DEVEL_PREFIX})
else()
  set(ukf_localization_SOURCE_PREFIX "")
  set(ukf_localization_DEVEL_PREFIX "")
  set(ukf_localization_INSTALL_PREFIX /usr/local)
  set(ukf_localization_PREFIX ${ukf_localization_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'ukf_localization' is deprecated")
...
set(ukf_localization_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/qian/my_lio_sam/src/ukf_localization/include;/usr/include/pcl-1.8;/usr/local/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/opt/ensenso/development/c/include;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl " STREQUAL " ")
  set(ukf_localization_INCLUDE_DIRS "")
  set(_include_dirs "/home/qian/my_lio_sam/src/ukf_localization/include;/usr/include/pcl-1.8;/usr/local/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/opt/ensenso/development/c/include;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${ukf_localization_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ukf_localization' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'ukf_localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/qian/my_lio_sam/src/ukf_localization/${idir}'.  ${_report}")
    endif()
    _list_append_unique(ukf_localization_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND ukf_localization_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND ukf_localization_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT ukf_localization_NUM_DUMMY_TARGETS)
      set(ukf_localization_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::ukf_localization::wrapped-linker-option${ukf_localization_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR ukf_localization_NUM_DUMMY_TARGETS "${ukf_localization_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::ukf_localization::wrapped-linker-option${ukf_localization_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND ukf_localization_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(ukf_localization_LIBRARY_DIRS ${lib_path})
      list(APPEND ukf_localization_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'ukf_localization'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND ukf_localization_LIBRARIES ${lib})
    endif()
  endif()
...
set(ukf_localization_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${ukf_localization_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 ukf_localization_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${ukf_localization_dep}_FOUND)
      find_package(${ukf_localization_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ukf_localization_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(ukf_localization_INCLUDE_DIRS ${${ukf_localization_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(ukf_localization_LIBRARIES ${ukf_localization_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${ukf_localization_dep}_LIBRARIES})
  _list_append_deduplicate(ukf_localization_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(ukf_localization_LIBRARIES ${ukf_localization_LIBRARIES})

  _list_append_unique(ukf_localization_LIBRARY_DIRS ${${ukf_localization_dep}_LIBRARY_DIRS})
  list(APPEND ukf_localization_EXPORTED_TARGETS ${${ukf_localization_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${ukf_localization_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
