...
if(grid_map_generator_CONFIG_INCLUDED)
  return()
endif()
set(grid_map_generator_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(grid_map_generator_SOURCE_PREFIX /home/qian/my_lio_sam/src/SmartCar-Tools/map_tools/modules/grid_map_generator)
  set(grid_map_generator_DEVEL_PREFIX /home/qian/my_lio_sam/src/build/devel)
  set(grid_map_generator_INSTALL_PREFIX "")
  set(grid_map_generator_PREFIX ${grid_map_generator_DEVEL_PREFIX})
else()
  set(grid_map_generator_SOURCE_PREFIX "")
  set(grid_map_generator_DEVEL_PREFIX "")
  set(grid_map_generator_INSTALL_PREFIX /usr/local)
  set(grid_map_generator_PREFIX ${grid_map_generator_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'grid_map_generator' is deprecated")
...
set(grid_map_generator_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/usr/include/pcl-1.8;/usr/local/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/opt/ensenso/development/c/include;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl " STREQUAL " ")
  set(grid_map_generator_INCLUDE_DIRS "")
  set(_include_dirs "/usr/include/pcl-1.8;/usr/local/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/opt/ensenso/development/c/include;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl")
  if(NOT " " STREQUAL " ")
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    list(APPEND grid_map_generator_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/qian/my_lio_sam/src/build/devel/lib;/opt/ros/melodic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(grid_map_generator_LIBRARY_DIRS ${lib_path})
      list(APPEND grid_map_generator_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'grid_map_generator'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND grid_map_generator_LIBRARIES ${lib})
    endif()
  endif()
...
set(grid_map_generator_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${grid_map_generator_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "pcl_ros;roscpp;rospy;sensor_msgs;std_msgs")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 grid_map_generator_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${grid_map_generator_dep}_FOUND)
      find_package(${grid_map_generator_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${grid_map_generator_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(grid_map_generator_INCLUDE_DIRS ${${grid_map_generator_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(grid_map_generator_LIBRARIES ${grid_map_generator_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${grid_map_generator_dep}_LIBRARIES})
  _list_append_deduplicate(grid_map_generator_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(grid_map_generator_LIBRARIES ${grid_map_generator_LIBRARIES})

  _list_append_unique(grid_map_generator_LIBRARY_DIRS ${${grid_map_generator_dep}_LIBRARY_DIRS})
  list(APPEND grid_map_generator_EXPORTED_TARGETS ${${grid_map_generator_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${grid_map_generator_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
