...
if(traj_generator_CONFIG_INCLUDED)
  return()
endif()
set(traj_generator_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(traj_generator_SOURCE_PREFIX /home/qian/my_lio_sam/src/SmartCar-Tools/map_tools/modules/trajectory_generator)
  set(traj_generator_DEVEL_PREFIX /home/qian/my_lio_sam/src/build/devel)
  set(traj_generator_INSTALL_PREFIX "")
  set(traj_generator_PREFIX ${traj_generator_DEVEL_PREFIX})
else()
  set(traj_generator_SOURCE_PREFIX "")
  set(traj_generator_DEVEL_PREFIX "")
  set(traj_generator_INSTALL_PREFIX /usr/local)
  set(traj_generator_PREFIX ${traj_generator_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'traj_generator' is deprecated")
...
set(traj_generator_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/qian/my_lio_sam/src/SmartCar-Tools/map_tools/modules/trajectory_generator/include;/usr/include/pcl-1.8;/usr/local/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/opt/ensenso/development/c/include;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl " STREQUAL " ")
  set(traj_generator_INCLUDE_DIRS "")
  set(_include_dirs "/home/qian/my_lio_sam/src/SmartCar-Tools/map_tools/modules/trajectory_generator/include;/usr/include/pcl-1.8;/usr/local/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/opt/ensenso/development/c/include;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl")
  if(NOT " " STREQUAL " ")
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    list(APPEND traj_generator_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(traj_generator_LIBRARY_DIRS ${lib_path})
      list(APPEND traj_generator_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'traj_generator'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND traj_generator_LIBRARIES ${lib})
    endif()
  endif()
...
set(traj_generator_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${traj_generator_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 traj_generator_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${traj_generator_dep}_FOUND)
      find_package(${traj_generator_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${traj_generator_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(traj_generator_INCLUDE_DIRS ${${traj_generator_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(traj_generator_LIBRARIES ${traj_generator_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${traj_generator_dep}_LIBRARIES})
  _list_append_deduplicate(traj_generator_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(traj_generator_LIBRARIES ${traj_generator_LIBRARIES})

  _list_append_unique(traj_generator_LIBRARY_DIRS ${${traj_generator_dep}_LIBRARY_DIRS})
  list(APPEND traj_generator_EXPORTED_TARGETS ${${traj_generator_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${traj_generator_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
